...
// ✅ final correct version (use this only)
const userRole = session?.role || session?.userType || 'user';

const isAdmin =
  userRole === 'admin' || session?.control_type === 'OWNER';
